...
export const preferredregion = [
  'icn1', 'sin1', 'hnd1', 'kix1', 'bom1', 'cpt1', 'pdx1', 'cle1', 'syd1', 'iad1', 'sfo1', 'gru1', ];duetoGemini-1.5-proisnotavailableinHongKong,weneedtosetthepreferredregiontoexcludethepaidserviceoftheGeminiAPIisrequiredinthefollowingregionsuntil8July2024.Thefreeserviceisnotavailable.Therefore,theregionsistemporarilydisabled.regionsincludeDublinParisFrankfurtLondonandStockholmrefs
