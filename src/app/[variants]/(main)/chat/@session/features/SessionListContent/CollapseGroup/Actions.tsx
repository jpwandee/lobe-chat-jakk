import { ActionIcon, Dropdown, type DropdownProps, Icon, type MenuProps }
import { App }
import { createStyles }
import { MoreVertical, PencilLine, Plus, Settings2, Trash }
import { memo, useMemo }
...
type ItemOfType<T> = T extends (infer Item)[] ? Item : never;ItemOfType<T>TextendsItem
